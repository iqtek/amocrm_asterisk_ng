    ...
    async def upload(self) -> None:
        ...
        self.__dispatcher.add_function(
            ...
            IsInternalNumberFunctionImpl(
                is_user_phone_number=self.__dispatcher.get_function(IsOperatorPhoneNumerQuery),
        ...
        call_completed_event_handler = CallCompletedEventHandler(
            ...
            get_user_id_by_phone_query=self.__dispatcher.get_function(IGetOperatorIdByPhoneQuery),
