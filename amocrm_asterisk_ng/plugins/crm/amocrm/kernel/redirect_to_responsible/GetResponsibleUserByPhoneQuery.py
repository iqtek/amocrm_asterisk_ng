...
__all__ = [
    "GetResponsibleOperatorByPhoneQuery",
]


class GetResponsibleOperatorByPhoneQuery(IGetResponsibleOperatorByPhoneQuery):
    ...
    def __init__(
        ...
        get_phone_by_user_id_query: IGetPhoneByOperatorIdQuery,
    ) -> None:
